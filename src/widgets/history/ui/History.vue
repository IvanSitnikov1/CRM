<template>
  <div class="wrapper wrapper_big-margin">
    <section class="history">
      ...
      <div class="history__persons">
        <div class="history__person" v-for="index in 3" :key="index">
          <div class="history__header">
            <div class="history__profile">
              <img class="history__image" src="./../../../shared/assets/test.png" alt="profile">
            </div>
            <div class="history__info">
              ...
              <div class="history__job">UI/UX Designer</div>
            </div>
          </div>
          <div class="history__actions">
            <div class="history__action" v-for="index in 2" :key="index">
